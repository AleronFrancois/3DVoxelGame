...
using System;
using System.Drawing;  // For loading image
using System.Drawing.Imaging; // For image manipulation
...
public static class BlockMesh
{
    ...
    {
        // Back face
        1f, 1f, 0f,  1f, 1f,   // Position + Texture coordinates (x, y)
        1f, 0f, 0f,  1f, 0f,
        0f, 0f, 0f,  0f, 0f,
        0f, 1f, 0f,  0f, 1f, 
    ...
    public static (int VAO, int VBO, int EBO, int texture) CreateBlock(string textureFilePath)
    {
        ...
        // Set up vertex attribute pointers (positions and texture coordinates)
